...
const ForgotPasswordPage = () => {
    ...
    http
      ...
      .then((res) => {
        if (res.forgot_password_token) {
          ...
          toast.success(
            "OTP gửi qua email thành công,vui lòng kiểm tra email ",
            {
              position: "top-right",
            }
          );
      ...
      .catch((err) => {
        ...
        if (err.response.data.message == "Not Found") {
          setShowPassword(false);
          toast.error(
            "Tài khoản không tồn tại trên hệ thống, vui lòng nhập lại thông tin!",
            {
              position: "top-right",
            }
          );
  ...
  const handleForgotPassword = (event: any) => {
    ...
    http
      ...
      .catch((err) => {
        console.log(
          "🚀 ~ file: forgotPassword.tsx:106 ~ handleForgotPassword ~ err:",
          err
        );
