        ...
        <form autoComplete="off" onSubmit={handleSubmit(RegisterSubmit)}>
            ...
            >
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <OutlinedInput key={1} {...field} fullWidth placeholder="Vui lòng nhập tên của bạn!" />
                    )}
                />
            </FormControl>
            ...
            >
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <OutlinedInput {...field} fullWidth placeholder="Vui lòng nhập Email của bạn!" />
                    )}
                />
            </FormControl>
            <Typography variant="caption" color={color.error}>
            ...
            >
                ...
                <Controller
                    ...
                    render={({ field }) => <OutlinedInput {...field} fullWidth placeholder="Vui lòng nhập mật khẩu" />}
                />
            </FormControl>
            <Typography variant="caption" color={color.error}>
            ...
            <Box mx={'auto'} textAlign={'center'} pt={3}>
                <Button
                    sx={{
                        width: '100%',
                        fontSize: '12px',
